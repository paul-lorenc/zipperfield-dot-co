  ...
  return (
    <div className="bg-white dark:bg-black">
      <div className="flex flex-col font-serif items-center bg-white dark:bg-black">
        <nav className="z-20 sticky-nav flex dark:text-white text-3xl font-bold  justify-between max-w-6xl xl:max-w-full xl:px-24 lg:pt-6 xl:pt-12 w-full items-start my-2 pt-2 px-4 md:px-8 mx-auto bg-white dark:bg-black">
          <Link href="/">
            <a>
              <ZFIcon />
            </a>
        ...
        <main className="flex z-1 min-h-screen justify-center w-full">
          {children}
        </main>
      </div>
    </div>
