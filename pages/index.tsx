...
export default function Home() {
  ...
  useEffect(() => {
    TweenMax.from(flowerRef, 1, { y: 50, opacity: 0, ease: "power2.out" });
  }, []);
  return (
    <Container>
      <div className="z-1 text-black dark:text-white">
        <div
          className="zf-switch flex flex-col h-screen bg-white dark:bg-black"
          ref={(el: any) => {
            flowerRef = el;
          }}
        >
          ...
          <div className="flex justify-left items-start">
            <button className="bg-blue-200 dark:bg-blue-800 bg-opacity-60 px-3 py-1 text-xl font-bold border border-blue-50 dark:border-blue-900 mx-10">
              Start Now
            </button>
