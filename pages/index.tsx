...
export default function Home() {
  return (
    <Container>
      <div className="font-serif w-screen px-4 text-black dark:text-white text-2xl font-extrabold  max-w-3xl">
        <div className="flex flex-col-reverse md:flex-row items-center md:items-start border border-black dark:border-white md:px-4 pb-1 mt-16 md:mt-20">
